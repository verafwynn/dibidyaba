...
token = MTExOTM4OTc1MTc3NTA3NjM2Mw.G-OP7W.shdFoGn6nab9GozU0vsxfSy7fWom8-GnmzjhjE
editing = {
...
async def on_message(message):
    ...
    #print(title)
      ...
      if "pokémon has appeared" in title:
        ...
        m = await message.channel.send("<@716390085896962058> hint")
      ...
      for i in first_options:
        await message.channel.send(" <@716390085896962058> catch "+i)
